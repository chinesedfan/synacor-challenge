...
fn.run = function() {
	...
	while (!this.halt) {
        switch (this.ip) {
        case 3032:
            // special id that stands for game status node
            nodeDebug('$node.id=%d(%s)', this.memory[2732], this.register.toString());
            break;
        case 5451:
            // calculated by tools/r7solver.js
            this.register[7] = 25734;
            break;
        case 5489:
            // not call 6027 any more
            this.memory[5489] = 21;
            this.memory[5490] = 21;
            break;
        case 5491:
